...
class Blockchain: 
    ...
    def proof_of_work(self, previous_proof):
        ...
        while check_proof is False: 
            hash_operation = hashlib.sha256(str(new_proof**2 - previous_proof**2).encode()).hexdigest() # must be non-symmetrical
    ...
    def add_node(self, address): 
        ...
        self.nodes.add(parsed_url.netloc) # parsed_url.netloc gives the hostname:port eg: 127.0.0.1:6000
